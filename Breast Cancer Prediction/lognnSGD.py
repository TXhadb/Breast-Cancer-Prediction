...
def fit_predict(train_data, test_observables, hidden_variables, num_epochs):
    ...
    opt = tf.keras.optimizers.SGD(learning_rate = 0.08, momentum = 0, nesterov = True)
...
if __name__ == '__main__':
    ...
    print('The time cost for lognnSGD is ' + str(round(time.time() - start, 2)) + ' seconds.')
    res.to_csv('lognnSGD_predictions.csv', index = False)
